...
import static com.expensemanager.expensemanager.database.DatabaseContract.*;
...
public class DBHelper extends SQLiteOpenHelper {
    ...
    }//context locating path of the Database

    private static final String CREATE_TABLE_TRANSACTIONS = "CREATE TABLE " + Transactions.TABLE_TRANSACTION +
            " (" +
            Transactions.COLUM_TXN_ID + " INTEGER PRIMARY KEY," +
            ...
            Transactions.COLUMN_SATATUS + " VARCHAR(1)" +
            ")";
    ...
    private static final String INSERT_INFO_CATEGORY = "INSERT INTO " +
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL(INSERT_INFO_CATEGORY);
    }
    ...
    public boolean saveTransaction(TransactionModel transactionModel) {
        ...
        contentValues.put(Transactions.COLUMN_SATATUS, transactionModel.getStatus());
        ...
        if (sqLiteDatabase != null) {
            try {
                ...
                sqLiteDatabase.insertOrThrow(Transactions.TABLE_TRANSACTION, null, contentValues);
    ...
    public List<TransactionModel> getAllTransaction(String transactionType) {
        ...
        String sql = "SELECT *" +
                " FROM " + Transactions.TABLE_TRANSACTION +
        ...
        if (sqLiteDatabase != null) {
            ...
            if (cursor != null && cursor.getCount() != 0) {
                ...
                for (int i = 0; i < cursor.getCount(); i++) {
                    ...
                    transactionModel.setTxnID(cursor.getInt(cursor.getColumnIndex(Transactions.COLUM_TXN_ID)));
                    ...
                    transactionModel.setStatus(cursor.getString(cursor.getColumnIndex(Transactions.COLUMN_SATATUS)));
    ...
    public List<String> getAllCtegories() {
